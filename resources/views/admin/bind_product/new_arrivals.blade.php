...
<div class="row">
    <div class="col-xl-12">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">All New Arrivals Products</div>
                <div class="ibox-title text-right">
                	<a href="{{ route('admin.new-arrivals.create') }}" class="badge badge-info">
                ...
                <table class="table table-bordered table-striped text-nowrap text-sm text-center" id="featured-product-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<a href="{{ route('admin.new-arrivals.edit',$f_p->id) }}" 
			                    ...
			                    <form id="delete-f_p-{{ $f_p->id }}" action="{{ route('admin.new-arrivals.destroy',$f_p->id) }}" method="POST" style="display: none;">
			                        @csrf
			                        @method('DELETE')
			                    </form>
                            </td>
