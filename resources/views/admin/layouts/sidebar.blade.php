<nav class="page-sidebar" id="sidebar" style="position: absolute;">
    <div id="sidebar-collapse">
        ...
        @if(Request::is('admin*') && Auth::user()->role_id == 1)
            <ul class="side-menu metismenu">
                ...
                <li>
                    <a href="{{ route('admin.admins.index') }}"><i class="sidebar-item-icon fa fa-user"></i>
                        <span class="nav-label">
                            Our Admins
                            <span class="badge badge-success" style="float: right;">
                                {{ App\Model\Admin::where('role_id',2)->count()}}
                            </span>
                        </span>
                    </a>
                </li>
        ...
        {{-- extra admin --}}
        @if(Request::is('admin*') && Auth::user()->role_id == 2)
            <ul class="side-menu metismenu">
                <li>
                    <a class="active" href="{{ route('admin.dashboard') }}"><i class="sidebar-item-icon fa fa-th-large"></i>
                        <span class="nav-label">Dashboard</span>
                ...
                @if(Auth::user()->order_management == 1)
                    <li>
                        <a href="{{ route('admin.orders') }}"><i class="sidebar-item-icon fa fa-first-order"></i>
                            <span class="nav-label">
                                Orders
                ...
                @if(Auth()->user()->product_attribute_management == 1)
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-list-ul"></i>
                            <span class="nav-label">Product Attributes</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                ...
                @if(Auth::user()->offer_management == 1)
                <li>
                    <a href="{{ route('admin.offer.index') }}"><i class="sidebar-item-icon fa fa-percent"></i>
                        <span class="nav-label">Offer Product</span>
                    </a>
                ...
                @if(Auth::user()->voucher_management == 1)
                <li>
                    <a href="{{ route('admin.voucher-product.index') }}"><i class="sidebar-item-icon fa fa-money"></i>
                        <span class="nav-label">Voucher Product</span>
                    </a>
                ...
                @if(Auth::user()->coupon_management ==1)
                <li>
                    <a href="javascript:;"><i class="sidebar-item-icon fa fa-gift"></i>
                        <span class="nav-label">Coupon</span><i class="fa fa-angle-left arrow"></i></a>
                    <ul class="nav-2-level collapse">
                ...
                @if(Auth::user()->user_management ==1)
                <li>
                    <a href="{{ route('admin.users.index') }}"><i class="sidebar-item-icon fa fa-users"></i>
                        <span class="nav-label">
                            Our Users
                ...
                @if(Auth::user()->district_management == 1)
                <li>
                    <a href="{{ route('admin.district.index') }}"><i class="sidebar-item-icon fa fa-area-chart"></i>
                        <span class="nav-label">Districts</span>
                    </a>
